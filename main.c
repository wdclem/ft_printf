...
int main()
{
	...
	printf("oo %.f", 3.0);
	printf("\n");
	printf("Test %%#.f %%#.0f %%#.15Lf: %#.f %#.0f %#.15Lf\n", 1.5, 1.5, 1.5);
	printf("\n");
	printf("\n");
	...
	printf("printf{%f}{%lf}{%Lf}", 1444565444646.6465424242242, 1444565444646.6465424242242, 1444565444646.6465424242242l);
	printf("\n");
	ft_printf("{%f}{%lf}{%Lf}", -1444565444646.6465424242242454654, -1444565444646.6465424242242454654, -1444565444646.6465424242242454654l);
	printf("printf{%f}{%lf}{%Lf}", -1444565444646.6465424242242454654, -1444565444646.6465424242242454654, -1444565444646.6465424242242454654l);
	printf("\n");
	printf("\n");
	printf("\n");
	ft_printf("f conversion: %f\n", 9.999999);
	printf("\n");
	printf("\n");
